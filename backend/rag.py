...
TELECOM_SEED_DOCS: List[str] = [
    ...
    # ---------------------------------------------------------------------------
    "Telugu greeting: నమస్కారం! మీరు J S E E కస్టమర్ కేర్‌కు సంప్రదించినందుకు ధన్యవాదాలు. మీకు ఎలా సహాయం చేయగలను?",
    ...
    # ---------------------------------------------------------------------------
    "Kannada greeting: ನಮಸ್ಕಾರ! ನೀವು J S E E ಕಸ್ಟಮರ್ ಕೇರ್‌ಗೆ ಸಂಪರ್ಕಿಸಿದ್ದಕ್ಕೆ ಧನ್ಯವಾದಗಳು. ನಿಮಗೆ ಹೇಗೆ ಸಹಾಯ ಮಾಡಬಲ್ಲೆ?",
